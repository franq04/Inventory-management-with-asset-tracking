...
class PurchaseRequestController extends Controller
{
    ...
    protected function transformPurchaseRequest(PurchaseRequest $pr): array
    {
        ...
        return [
            ...
            'purpose' => $pr->purpose,
            'requested_delivery_date' => optional($pr->requested_delivery_date)->toDateString(),
            'requested_delivery_term' => $pr->requested_delivery_term,
            'requested_payment_term' => $pr->requested_payment_term,
            'sai_no' => $pr->sai_no,
