<div id="inventoryCreateModal" class="fixed inset-0 z-50 hidden opacity-0 transition-opacity duration-200">
...
<div id="inventoryViewModal" class="fixed inset-0 z-50 hidden opacity-0 transition-opacity duration-200">
    ...
    <div class="relative flex min-h-screen items-center justify-center p-4">
        ...
        <div class="relative flex flex-col w-full max-w-4xl rounded-2xl bg-white shadow-2xl max-h-[calc(100vh-2rem)]">
