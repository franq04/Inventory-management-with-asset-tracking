                                ...
                                <div class="mt-6 space-y-3 text-xs uppercase tracking-wide text-gray-600">
                                    <div class="border-b border-gray-500 pb-2">
                                        <div class="flex min-h-10 items-end gap-2">
                                            ...
                                            <span id="custodianPrRequestedSignature" class="block flex-1 text-center"></span>
                                        </div>
                                    </div>
                            ...
                            <div id="custodianPrRecommendedBlock" class="hidden">
                                ...
                                <div class="mt-6 space-y-3 text-xs uppercase tracking-wide text-gray-600">
                                    <div class="border-b border-gray-500 pb-2">
                                        <div class="flex min-h-10 items-end gap-2">
                                            <span class="w-20 shrink-0">Signature:</span>
                                            <span id="custodianPrRecommendedSignature" class="block flex-1 text-center"></span>
                                        </div>
                                    </div>
                            ...
                            <div>
                                ...
                                <div class="mt-6 space-y-3 text-xs uppercase tracking-wide text-gray-600">
                                    <div class="border-b border-gray-500 pb-2">
                                        <div class="flex min-h-10 items-end gap-2">
                                            <span class="w-20 shrink-0">Signature:</span>
                                            <span id="custodianPrApprovedSignature" class="block flex-1 text-center"></span>
                                        </div>
                                    </div>
