...
<div id="custodianPrModal" class="fixed inset-0 z-50 hidden" aria-labelledby="custodianPrModalTitle" role="dialog" aria-modal="true">
    <div class="absolute inset-0 bg-black/70 backdrop-blur-sm transition-opacity" data-close-modal></div>
    <div class="relative flex items-center justify-center min-h-screen p-4">
        {{-- FIX: Removed the vertical margin "my-8" to prevent overflow on small screens --}}
                            ...
                            <div class="border-b border-gray-400 p-5 space-y-4 md:border-b-0 md:border-r">
                                <div class="flex items-center justify-between gap-4">
                                    ...
                                    <div class="flex-1 text-right">
                                        <input type="text" readonly id="custodianPrDivisionInput" class="border-b border-gray-500 px-2 py-1 text-right text-sm text-gray-900 bg-transparent">
                                    </div>
                                </div>
                                <div class="flex items-center justify-between gap-4">
                                    <label class="text-sm font-semibold uppercase tracking-wide text-gray-700">Section :</label>
                                    <div class="flex-1 text-right">
                                        <input type="text" readonly id="custodianPrSectionInput" class="border-b border-gray-500 px-2 py-1 text-right text-sm text-gray-900 bg-transparent">
                                    </div>
                                </div>
                            </div>
                            <div class="p-5">
                                <div class="grid grid-cols-[auto,1fr] gap-x-3 gap-y-3 text-sm text-gray-700">
                                    ...
                                    <span id="custodianPrNo" class="border-b border-gray-500 px-2 py-1 text-right text-gray-900"></span>
                                    <span class="font-semibold uppercase tracking-wide">Date:</span>
                                    <span id="custodianPrDate" class="border-b border-gray-500 px-2 py-1 text-right text-gray-900"></span>
                                    <label class="font-semibold uppercase tracking-wide">SAI No.:</label>
                                    <input type="text" readonly id="custodianPrSaiInput" class="border-b border-gray-500 px-2 py-1 text-right text-sm text-gray-900">
                                    <label class="font-semibold uppercase tracking-wide">ALOBS No.:</label>
                                    <input type="text" readonly id="custodianPrAlobsInput" class="border-b border-gray-500 px-2 py-1 text-right text-sm text-gray-900">
                                    <label class="font-semibold uppercase tracking-wide">Fund Cluster:</label>
                                    <input type="text" readonly id="custodianPrFundClusterInput" class="border-b border-gray-500 px-2 py-1 text-right text-sm text-gray-900">
                                    <label class="font-semibold uppercase tracking-wide">Funds Available:</label>
                                    <input type="text" readonly id="custodianPrFundsAvailableInput" class="border-b border-gray-500 px-2 py-1 text-right text-sm text-gray-900">
                                </div>
                            </div>
                        </div>
                    </div>
