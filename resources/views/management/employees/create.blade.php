        ...
        <div class="form-step hidden" data-step="2">
            <section class="rounded-2xl border border-emerald-950/8 bg-white p-6 shadow-[0_16px_40px_-30px_rgba(15,23,42,0.45)] space-y-6 sm:p-7">
                ...
                <div>
                    ...
                    <select id="position_id" name="position_id" data-selected="{{ old('position_id') }}" class="mt-1 h-12 w-full rounded-xl border-gray-200 bg-[#f8faf9] px-4 focus:border-emerald-500 focus:bg-white focus:ring-4 focus:ring-emerald-500/15 shadow-sm">
                        <option value="">Unassigned</option>
                    </select>
