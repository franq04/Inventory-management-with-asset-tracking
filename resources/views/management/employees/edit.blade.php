                 ...
                 <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input id="first_name" name="first_name" type="text" value="{{ old('first_name', $employee->first_name) }}" class="mt-1 h-12 w-full rounded-xl border-gray-200 bg-[#f8faf9] px-4 focus:border-emerald-500 focus:bg-white focus:ring-4 focus:ring-emerald-500/15 shadow-sm" placeholder="e.g. Juan" autocomplete="given-name" />
                            @error('first_name')<p class="mt-1 text-xs text-red-600">{{ $message }}</p>@enderror
                        </div>
                        <div>
                            <label for="middle_name" class="text-xs font-semibold uppercase tracking-[0.12em] text-gray-500">Middle Name</label>
                            <input id="middle_name" name="middle_name" type="text" value="{{ old('middle_name', $employee->middle_name) }}" class="mt-1 h-12 w-full rounded-xl border-gray-200 bg-[#f8faf9] px-4 focus:border-emerald-500 focus:bg-white focus:ring-4 focus:ring-emerald-500/15 shadow-sm" placeholder="e.g. Santos" autocomplete="additional-name" />
                         ...
                         <div>
                            ...
                            <input id="last_name" name="last_name" type="text" value="{{ old('last_name', $employee->last_name) }}" class="mt-1 h-12 w-full rounded-xl border-gray-200 bg-[#f8faf9] px-4 focus:border-emerald-500 focus:bg-white focus:ring-4 focus:ring-emerald-500/15 shadow-sm" placeholder="e.g. Dela Cruz" autocomplete="family-name" />
                        ...
                        <div>
                         ...
                         <div>
                            ...
                            <input id="date_of_birth" name="date_of_birth" type="date" value="{{ old('date_of_birth', $employee->date_of_birth) }}" class="mt-1 h-12 w-full rounded-xl border-gray-200 bg-[#f8faf9] px-4 focus:border-emerald-500 focus:bg-white focus:ring-4 focus:ring-emerald-500/15 shadow-sm" max="{{ now()->toDateString() }}" autocomplete="bday" />
                ...
                <div class="grid gap-5 sm:grid-cols-2">
                    <div>
                        ...
                        <div class="relative mt-1">
                            ...
                            <input id="contact_no" name="contact_no" type="text" value="{{ old('contact_no', $employee->contact_no) }}" class="h-12 w-full rounded-xl border-gray-200 bg-[#f8faf9] pl-14 pr-4 focus:border-emerald-500 focus:bg-white focus:ring-4 focus:ring-emerald-500/15 shadow-sm" placeholder="9XXXXXXXXX" inputmode="numeric" maxlength="10" autocomplete="tel-national" aria-describedby="contact_no_helper" />
                        </div>
