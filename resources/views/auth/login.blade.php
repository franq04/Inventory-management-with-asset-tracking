        ...
        <div class="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
            ...
            <form id="loginForm" class="space-y-6" method="POST" action="{{ route('login.post') }}">
                ...
                <div class="floating-label-group input-glow rounded-xl transition-shadow duration-300">
                    ...
                    <input type="text" id="login-username" name="username" value="{{ old('username') }}" required class="floating-input block w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-0 focus:border-[var(--primary-color)] transition" placeholder=" " aria-describedby="login-username-error" aria-invalid="{{ $errors->has('username') ? 'true' : 'false' }}" autocomplete="username">
                    <label for="login-username" class="floating-label">Username</label>
                </div>
                <p id="login-username-error" class="-mt-4 text-sm font-medium text-red-600 min-h-[1.25rem]" role="alert" aria-live="polite">{{ $errors->first('username') }}</p>
                
                <div class="floating-label-group input-glow rounded-xl transition-shadow duration-300">
                     <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none z-10">
                       <svg class="h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" /></svg>
                    </div>
                    <input type="password" id="login-password" name="password" required class="floating-input block w-full pl-10 pr-10 py-3 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-0 focus:border-[var(--primary-color)] transition" placeholder=" " aria-describedby="login-password-error" aria-invalid="{{ $errors->has('password') ? 'true' : 'false' }}" autocomplete="current-password">
