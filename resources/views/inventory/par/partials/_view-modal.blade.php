<div id="parViewModal" class="fixed inset-0 z-50 hidden opacity-0 transition-opacity duration-200 ease-out">
    {{-- Backdrop --}}
    ...
    <div class="relative flex min-h-screen items-center justify-center p-4">
        ...
        <div class="relative flex w-full max-w-5xl flex-col rounded-2xl bg-white shadow-2xl max-h-[calc(100vh-2rem)]">
            ...
            <div class="flex-shrink-0 flex flex-wrap items-center justify-between gap-4 bg-gradient-to-r from-[#1a3a2d] to-[#2d5a4a] px-8 py-6 text-white">
                <div class="space-y-3">
                    <span class="text-xs font-semibold uppercase tracking-[0.35em] text-white/70">Property Acknowledgment Receipt</span>
                    <div class="flex flex-wrap items-center gap-2 text-sm font-semibold text-white/90">
                        <div class="inline-flex items-center gap-3 rounded-full bg-white/15 px-4 py-1.5">
                            ...
                            <span id="parViewPropertyNo">—</span>
                        </div>
                        <div class="inline-flex items-center gap-3 rounded-full bg-white/15 px-4 py-1.5">
                            <i class="fas fa-calendar-day"></i>
                            <span id="parViewDateAcquiredChip">—</span>
                        </div>
                    </div>
                </div>
                <div class="flex flex-wrap items-center gap-3">
                    <a href="#" id="parPrintButton" target="_blank" class="inline-flex items-center gap-2 rounded-full border border-white/40 bg-white/10 px-4 py-2 text-sm font-semibold text-white transition hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-white/60">
                ...
                <div class="mx-auto w-full max-w-5xl space-y-8">
                    <section>
                        ...
                        <div class="mt-4 grid grid-cols-1 gap-x-8 gap-y-4 text-sm text-gray-800 md:grid-cols-2">
                            <div>
                                ...
                                <p id="parViewArticle" class="mt-1 font-semibold text-gray-900">—</p>
                            </div>
                            <div>
                                <p class="text-xs font-semibold uppercase tracking-wide text-gray-500">Property Number</p>
                                <p id="parViewPropertyNoSnapshot" class="mt-1 font-semibold text-gray-900">—</p>
                            </div>
                            <div>
                                <p class="text-xs font-semibold uppercase tracking-wide text-gray-500">Acquisition Date</p>
                                <p id="parViewDateSnapshot" class="mt-1 font-semibold text-gray-900">—</p>
                            </div>
                            <div>
                                <p class="text-xs font-semibold uppercase tracking-wide text-gray-500">PAR Number</p>
                                <p id="parViewNumber" class="mt-1 font-semibold text-gray-900">—</p>
                            </div>
                            <div>
                                <p class="text-xs font-semibold uppercase tracking-wide text-gray-500">Accountable Officer</p>
                                <p id="parViewOfficer" class="mt-1 font-semibold text-gray-900">—</p>
                                <p class="text-xs text-gray-500">Employee ID: <span id="parViewOfficerId">—</span></p>
                            </div>
                            <div>
                                <p class="text-xs font-semibold uppercase tracking-wide text-gray-500">Quantity &amp; Unit</p>
                                <p id="parViewQuantitySnapshot" class="mt-1 font-semibold text-gray-900">—</p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                            <div class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
                                ...
                                <p id="parViewDateAcquired" class="mt-2 text-base font-semibold text-gray-900">—</p>
                            </div>
                            <div class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
                                <p class="text-xs font-semibold uppercase tracking-wide text-gray-500">Category</p>
                                <p id="parViewCategory" class="mt-2 text-base font-semibold text-gray-900">—</p>
                            </div>
                            <div class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
                                <p class="text-xs font-semibold uppercase tracking-wide text-gray-500">Unit</p>
                                <p id="parViewUnit" class="mt-2 text-base font-semibold text-gray-900">—</p>
                            </div>
                            <div class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
                                <p class="text-xs font-semibold uppercase tracking-wide text-gray-500">Quantity</p>
                                <p id="parViewQuantity" class="mt-2 text-base font-semibold text-gray-900">—</p>
                            </div>
                            <div class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
                                <p class="text-xs font-semibold uppercase tracking-wide text-gray-500">Unit Value</p>
                                <p id="parViewUnitValue" class="mt-2 text-base font-semibold text-gray-900">—</p>
                            </div>
                            <div class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
                                <p class="text-xs font-semibold uppercase tracking-wide text-gray-500">Total Amount</p>
                                <p id="parViewAmount" class="mt-2 text-base font-semibold text-gray-900">—</p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                            ...
                            <p id="parViewDescription" class="mt-3 text-sm leading-relaxed text-gray-700">—</p>
                        </div>
                        <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                            <h4 class="text-xs font-semibold uppercase tracking-wide text-gray-500">Serial Numbers</h4>
                            <ul id="parViewSerials" class="mt-3 space-y-2 text-sm text-gray-700">
                    ...
                    <section>
                        <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                            ...
                            <p id="parViewRemarks" class="mt-3 text-sm text-gray-700">No additional remarks recorded.</p>
                        </div>
                    </section>
                </div>
            </div>
