...
<head>
    ...
    <title>Inventory Custodian Slip Registry</title>
    ...
    <div class="mb-6 border-b-2 border-black pb-4">
        <div class="flex items-center justify-between">
            ...
            <div class="flex-1 text-center">
                <h1 class="text-2xl font-bold uppercase">Inventory Custodian Slip Registry</h1>
                <p class="text-sm mt-1">Comprehensive ICS Report</p>
                @if($search || !empty($categoryFilters))
    ...
    @foreach($chunks as $chunkIndex => $chunk)
        @if($chunkIndex > 0)
            ...
            <div class="mb-4 text-center border-b border-black pb-2">
                <h2 class="text-lg font-bold">ICS Registry (continued)</h2>
        ...
        <table class="w-full border-collapse text-xs">
            <thead>
                <tr class="bg-gray-100 border-black">
                    <th class="border border-black px-2 py-2 text-left font-semibold w-24">ICS No.</th>
                    ...
                    <th class="border border-black px-2 py-2 text-right font-semibold w-20">Unit Cost</th>
                    <th class="border border-black px-2 py-2 text-right font-semibold w-24">Total Cost</th>
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-50">
                    <td class="border border-black px-2 py-1.5 text-xs">{{ $record->ics_no }}</td>
        ...
        <div class="mt-6 border-t-2 border-black pt-4">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-sm font-semibold mt-1">Total Cost: ₱{{ number_format($totalCost, 2) }}</p>
                </div>
