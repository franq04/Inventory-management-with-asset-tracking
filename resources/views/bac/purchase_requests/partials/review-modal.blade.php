                    ...
                    <div class="border-b border-gray-400 px-5 py-2.5">
                        <div class="grid grid-cols-1 gap-x-5 gap-y-1.5 text-xs text-gray-700 md:grid-cols-[1fr_1.1fr_0.7fr]">
                            ...
                            <div class="flex items-end gap-2">
                                ...
                                <span id="bacPrRequestedDeliveryDate" class="flex-1 border-b border-gray-500 pb-0.5 text-right text-sm text-gray-900"></span>
                            </div>
                            <div class="flex items-end gap-2">
                                <span class="font-bold uppercase tracking-wider whitespace-nowrap">Req. Delivery Term:</span>
                                <span id="bacPrRequestedDeliveryTerm" class="flex-1 border-b border-gray-500 pb-0.5 text-right text-sm text-gray-900"></span>
                            </div>
                            <div class="flex items-end gap-2">
                                <span class="font-bold uppercase tracking-wider whitespace-nowrap">Req. Payment Term:</span>
                                <span id="bacPrRequestedPaymentTerm" class="flex-1 border-b border-gray-500 pb-0.5 text-right text-sm text-gray-900"></span>
                            </div>
                        </div>
                    </div>
